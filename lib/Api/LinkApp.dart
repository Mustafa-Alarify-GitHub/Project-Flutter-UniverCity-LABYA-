class Linkapp{
   static const String server ="http://192.168.127.1:8000/api";

  static const String Get_All_Cat ="$server/get-all-catogries";
  static const String Get_One_Books ="$server/get-books"; // parms ID
